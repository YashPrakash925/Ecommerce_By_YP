...
export function HomePage({cart,GetCart}) {
  ...
  useEffect(()=>{
    const getHomeData=async ()=>{
      const urlPath=search?`https://ecommerce-by-yp.onrender.com/api/products?search=${search}` : 'https://ecommerce-by-yp.onrender.comecommerce-by-yp.onrender.com/api/products';
